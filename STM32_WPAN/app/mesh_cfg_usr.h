...
#define DEVICE_NAME          		'T','o','F',' ','&',' ','C','o','l','o','r'
...
#define ENABLE_LIGHT_MODEL_SERVER_LIGHTNESS                                  (0)
#define ENABLE_LIGHT_MODEL_SERVER_LIGHTNESS_SETUP                            (0)
...
#if ENABLE_SENSOR_MODEL_SERVER==1
#undef DEVICE_NAME
#undef DEVICE_NAME_SIZE
#define DEVICE_NAME_SIZE                                                      11
#define DEVICE_NAME          		'S','e','n','s',' ','S','e','r','v','e','r'
#endif
...
#undef DEVICE_NAME_SIZE
#define DEVICE_NAME_SIZE                                                      11
#define DEVICE_NAME          		'S','e','n','s',' ','C','l','i','e','n','t'
#endif
...
#define ENABLE_VENDOR_MODEL_SERVER                                           (0)
