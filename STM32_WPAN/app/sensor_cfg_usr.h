...
* 0x0000 - Prohibited
*/
#define SENSOR1_PROPERTY_ID                    INITIAL_CIE_1931_CHROMATICITY_COORDINATES_PID
...
#define SENSOR1_DATA_LENGTH                    8
#define SENSOR1_CADENCE_STATE                  SENSOR_CADENCE_NOT_SUPPORTED
#define SENSOR1_VALUES_RANGE                   0
...
#define SENSOR2_DATA_LENGTH                    128
...
#define SENSOR2_SETTINGS_INIT_PARAMS \
{\
