...
/******************************************************************************/
  ...
  case SENSOR_GET:
    {  
      TRACE_M(TF_SENSOR, "Sensor_Get Op Code recog\r\n");
                                  ...
                                  MOBLEUINT8 elementIndex)
{
  ...
  TRACE_M(TF_SERIAL_CTRL,"#%d! for element %d with length: %d\r\n",
                         ...
                         MOBLEUINT8 elementIndex)
{
  ...
  TRACE_M(TF_SERIAL_CTRL,"#%d! for element %d with length of %d\r\n",
          SENSOR_STATUS,
          elementIndex,
		  length);
  for(i = 0; i < length; i++)
  {
    TRACE_M(TF_SERIAL_CTRL,"Status value: 0x%x\n\r", pStatus[i]);
  }
