...
#define CHATAL_Z_ADDR   (0x94)	// R      12
#define CHATAH_Z_ADDR   (0x95)	// R      13
#define CHATAL_Y_ADDR   (0x96)	// R      14
#define CHATAH_Y_ADDR   (0x97)	// R      15
#define CHATAL_IR_ADDR  (0x98)	// R      16
#define CHATAH_IR_ADDR  (0x99)	// R      17
#define CHATAL_X_ADDR   (0x9A)	// R      18
#define CHATAH_X_ADDR   (0x9B)	// R      19
#define CFG2_ADDR       (0x9F)	// R/W    20
#define CFG3_ADDR       (0xAB)	// R/W    21
#define AZ_CONFIG_ADDR  (0xD6)	// R/W    22
#define INTENAB_ADDR    (0xDD)	// R/W    23
