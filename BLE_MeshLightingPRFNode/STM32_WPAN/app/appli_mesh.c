...
/* Hardware Factory Restore implementation */
  ...
  HW_TS_Create(CFG_TIM_PROC_ID_ISR, &discoverTimer_Id2, hw_ts_Repeated, LoopTask);
...
#if (1)//TODO: try adding asynic things
#endif
