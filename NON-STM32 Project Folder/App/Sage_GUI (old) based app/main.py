...
class Color:
    def __init__(self):
        ...
        self.ax1.set_xlim(-7, 0)

        # CLEAR
        # RED
        self.xar = [-7,-6,-5,-4,-3,-2,-1,0]
        self.yar = [0,0,0,0,0,0,0,0]
        self.line, = self.ax1.plot(self.xar, self.yar, 'r', marker='o')
        # GREEN
        self.yar1 = [0,0,0,0,0,0,0,0]
        self.line1, = self.ax1.plot(self.xar, self.yar1, 'g', marker='o')
        # BLUE
        self.yar2 = [0,0,0,0,0,0,0,0]
        self.line2, = self.ax1.plot(self.xar, self.yar2, 'b', marker='o')
        # PROX
